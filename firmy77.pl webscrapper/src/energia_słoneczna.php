...
<body>
    ...
    <?php
        ...
        if(isset($_POST['submit']) && $region === 'cała_Polska'){
            ...
            include('linki/energia_słoneczna/energia_słoneczna.php');
            set_time_limit(0);
            $wynik_array = [];
            foreach ($energia_słoneczna as $link) {
            ...
            $file = fopen('energia_słoneczna.csv', 'w');
            file_put_contents('energia_słoneczna.csv',$wynik_array3);
            fclose($file);      
        }
        ?>
    </body>
