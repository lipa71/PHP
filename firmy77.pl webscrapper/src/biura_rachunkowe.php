...
<body>
    ...
    <?php
        ...
        if(isset($_POST['submit']) && $region === 'cała_Polska'){
            ...
            include('linki/biura_rachunkowe/biura_rachunkowe.php');
            set_time_limit(0);
            $wynik_array = [];
            foreach ($biura_rachunkowe as $link) {
            ...
            $file = fopen('biura_rachunkowe.csv', 'w');
            file_put_contents('biura_rachunkowe.csv',$wynik_array3);
            fclose($file);      
        }
        ?>
    </body>
