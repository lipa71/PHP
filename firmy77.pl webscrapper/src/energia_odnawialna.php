...
<body>
    ...
    <?php
        ...
        if(isset($_POST['submit']) && $region === 'cała_Polska'){
            ...
            include('linki/energia_odnawialna/energia_odnawialna.php');
            set_time_limit(0);
            $wynik_array = [];
            foreach ($energia_odnawialna as $link) {
            ...
            $file = fopen('energia_odnawialna.csv', 'w');
            file_put_contents('energia_odnawialna.csv',$wynik_array3);
            fclose($file);      
        }
        ?>
    </body>
