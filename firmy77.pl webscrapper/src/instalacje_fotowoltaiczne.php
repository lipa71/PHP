...
<body>
    <center>
        <h1>Instalacje_fotowoltaiczne</h1>
        <form method="POST">
            <select name="region">
    ...
    <?php
        ...
        if(isset($_POST['submit']) && $region === 'cała_Polska'){
            ...
            include('linki/instalacje_fotowoltaiczne/instalacje_fotowoltaiczne.php');
            set_time_limit(0);
            $wynik_array = [];
            foreach ($instalacje_fotowoltaiczne as $link) {
            ...
            $file = fopen('instalacje_fotowoltaiczne.csv', 'w');
            file_put_contents('instalacje_fotowoltaiczne.csv',$wynik_array3);
            fclose($file);      
        }
        ?>
    </body>
