...
<body>
    <center>
        <h1>Instalacja i serwis ogrzewania</h1>
        <form method="POST">
            <select name="region">
    ...
    <?php
        ...
        if(isset($_POST['submit']) && $region === 'cała_Polska'){
            ...
            include('linki/instalacja_i_serwis_ogrzewania/instalacja_i_serwis_ogrzewania.php');
            set_time_limit(0);
            $wynik_array = [];
            foreach ($instalacja_i_serwis_ogrzewania as $link) {
            ...
            $file = fopen('instalacja_i_serwis_ogrzewania.csv', 'w');
            file_put_contents('instalacja_i_serwis_ogrzewania.csv',$wynik_array3);
            fclose($file);      
        }
        ?>
    </body>
