...
<body>
    <center>
        <h1>wypozyczalnie_sprzetu_budowlanego</h1>
        <form method="POST">
            <select name="region">
    ...
    <?php
        ...
        if(isset($_POST['submit']) && $region === 'cała_Polska'){
            ...
            include('linki/wypozyczalnie_sprzetu_budowlanego/wypozyczalnie_sprzetu_budowlanego.php');
            set_time_limit(0);
            $wynik_array = [];
            foreach ($wypozyczalnie_sprzetu_budowlanego as $link) {
            ...
            $file = fopen('wypozyczalnie_sprzetu_budowlanego.csv', 'w');
            file_put_contents('wypozyczalnie_sprzetu_budowlanego.csv',$wynik_array3);
            fclose($file);      
        }
        ?>
    </body>
