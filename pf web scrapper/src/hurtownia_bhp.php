...
<body>
    ...
    <?php
        ...
        if(isset($_POST['submit']) && $region === 'cała_Polska'){
            ...
            include('linki/hurtownia_bhp/hurtownia_bhp.php');
            set_time_limit(0);
            $wynik_array = [];
            foreach ($hurtownia_bhp as $link) {
            ...
            $file = fopen('hurtownia_bhp.csv', 'w');
            file_put_contents('hurtownia_bhp.csv',$wynik_array3);
            fclose($file);      
        }
        ?>
    </body>
