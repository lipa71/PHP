...
<body>
    <center>
        <h1>Serwis i instalacja klimatyzacji</h1>
        <form method="POST">
            <select name="region">
    ...
    <?php
        ...
        if(isset($_POST['submit']) && $region === 'cała_Polska'){
            ...
            include('linki/serwis_i_instalacja_klimatyzacji/serwis_i_instalacja_klimatyzacji.php');
            set_time_limit(0);
            $wynik_array = [];
            foreach ($serwis_i_instalacja_klimatyzacji as $link) {
            ...
            $file = fopen('serwis_i_instalacja_klimatyzacji.csv', 'w');
            file_put_contents('serwis_i_instalacja_klimatyzacji.csv',$wynik_array3);
            fclose($file);      
        }
        ?>
    </body>
