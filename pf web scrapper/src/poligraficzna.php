...
if(isset($_POST['submit']) && $region == 'all'){
    ...
    include('linki/poligraficzna/poligraficzna.php');
    set_time_limit(0);
    $wynik_array = [];
    foreach ($poligraficzna as $link) {
    ...
    $file = fopen('poligraficzna.csv', 'w');
    file_put_contents('poligraficzna.csv',$wynik_array3);
    fclose($file);
}
