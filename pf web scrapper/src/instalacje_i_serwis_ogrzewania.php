...
<body>
    <center>
        <h1>Instalacje i serwis ogrzewania</h1>
        <form method="POST">
            <select name="region">
    ...
    <?php
        ...
        if(isset($_POST['submit']) && $region === 'cała_Polska'){
            ...
            include('linki/instalacje_i_serwis_ogrzewania/instalacje_i_serwis_ogrzewania.php');
            set_time_limit(0);
            $wynik_array = [];
            foreach ($instalacje_i_serwis_ogrzewania as $link) {
            ...
            $file = fopen('instalacje_i_serwis_ogrzewania.csv', 'w');
            file_put_contents('instalacje_i_serwis_ogrzewania.csv',$wynik_array3);
            fclose($file);      
        }
        ?>
    </body>
