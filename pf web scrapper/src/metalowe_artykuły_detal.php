...
<body>
    ...
    <?php
        ...
        if(isset($_POST['submit']) && $region === 'cała_Polska'){
            ...
            include('linki/metalowe_artykuły_detal/metalowe_artykuły_detal.php');
            set_time_limit(0);
            $wynik_array = [];
            foreach ($metalowe_artykuły_detal as $link) {
            ...
            $file = fopen('metalowe_artykuły_detal.csv', 'w');
            file_put_contents('metalowe_artykuły_detal.csv',$wynik_array3);
            fclose($file);      
        }
        ?>
    </body>
