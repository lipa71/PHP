...
if(isset($_POST['submit']) && $region == 'all'){
    ...
    include('linki/motoryzacyjna/motoryzacyjna.php');
    set_time_limit(0);
    $wynik_array = [];
    foreach ($motoryzacyjna as $link) {
    ...
    $file = fopen('motoryzacyjna.csv', 'w');
    file_put_contents('motoryzacyjna.csv',$wynik_array3);
    fclose($file);
}
