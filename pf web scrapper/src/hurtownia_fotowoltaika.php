...
<body>
    ...
    <?php
        ...
        if(isset($_POST['submit']) && $region === 'cała_Polska'){
            ...
            include('linki/hurtownia_fotowoltaika/hurtownia_fotowoltaika.php');
            set_time_limit(0);
            $wynik_array = [];
            foreach ($hurtownia_fotowoltaika as $link) {
            ...
            $file = fopen('hurtownia_fotowoltaika.csv', 'w');
            file_put_contents('hurtownia_fotowoltaika.csv',$wynik_array3);
            fclose($file);      
        }
        ?>
    </body>
