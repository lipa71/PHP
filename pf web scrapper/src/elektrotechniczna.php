...
if(isset($_POST['submit']) && $region == 'all'){
    ...
    include('linki/elektrotechniczna/elektrotechniczna.php');
    set_time_limit(0);
    $wynik_array = [];
    foreach ($elektrotechniczna as $link) {
    ...
    $file = fopen('elektrotechniczna.csv', 'w');
    file_put_contents('elektrotechniczna.csv',$wynik_array3);
    fclose($file);
}
