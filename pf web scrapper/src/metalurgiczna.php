...
if(isset($_POST['submit']) && $region == 'all'){
    ...
    include('linki/metalurgiczna/metalurgiczna.php');
    set_time_limit(0);
    $wynik_array = [];
    foreach ($metalurgiczna as $link) {
    ...
    $file = fopen('metalurgiczna.csv', 'w');
    file_put_contents('metalurgiczna.csv',$wynik_array3);
    fclose($file);
}
